...
const WeightTrendChart = () => {
  ...
  if (isLoading) {
    return (
      <div className="bg-white rounded-2xl p-4 border border-stone-200 h-48 animate-pulse" />
    );
  }
  ...
  return (
    <div className="bg-white rounded-2xl p-4 border border-stone-200">
      ...
      >
        ...
        <text x={4} y={PAD_T + 4} className="text-[10px] fill-stone-700">
          {view.max.toFixed(1)}
        </text>
        <text x={4} y={CHART_H - PAD_B + 12} className="text-[10px] fill-stone-700">
          {view.min.toFixed(1)}
        </text>
        ...
        {labels.map(({ idx, label }) => (
          <text
            ...
            y={CHART_H - 6}
            textAnchor="middle"
            className="text-[10px] fill-stone-700"
          >
            {label}
          </text>
        ))}
